...
<div class="wrap">
    ...
    <form method="post" action="">
        ...
        <p>
            ...
            _e('Enter your humans.txt below. Use the help button above for further guidance.', 'wp-humanstxt');
            ?></label>
            <a href='<?php echo home_url('humans.txt'); ?>' class='button button-small'>
            <?php _e('View', 'wp-humanstxt'); ?> humans.txt</a>
        </p>
        ...
        <a id="insert_base_template" class="button"><?php
            _e('Insert Base Template', 'wp-humanstxt');
        ?></a>
        </p>

        <h3><?php _e('Options', 'wp-humanstxt'); ?></h3>

        <table class="form-table">
            <tr valign="top">
                <th scope="row"><?php _e('Author link', 'wp-humanstxt'); ?></th>
                <td><label for="author_link">
                <input name="author_link" type="checkbox" id="author_link" value="1" <?php checked($options['author_link']); ?> />
                <?php _e('Place an author link to the file within the head of the site.', 'wp-humanstxt'); ?></label>
                </td>
            </tr>
        </table>
        ...
        <table class="form-table">
            <tr valign="top">
                <th scope="row"><label for="humanstxt_button"><?php _e('Humans.txt button', 'wp-humanstxt'); ?></label></th>
                <td>
                ...
                <p class="description">
                <?php _e('Add a button to the footer, which links to the humans.txt file.', 'wp-humanstxt'); ?>
                </p>
                </td>
            </tr>
        </table>
